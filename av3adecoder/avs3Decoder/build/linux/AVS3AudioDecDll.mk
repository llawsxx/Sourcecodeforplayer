...
DLL_NAME = libAVS3AudioDec.dll
IMPORT_LIB_NAME = libAVS3AudioDec.dll.a
...
CFLAGS += -Wl,--no-undefined -D_WIN32 -D_WINDOWS -DDLL_EXPORT
LDFLAGS += -shared -Wl,--out-implib=$(IMPORT_LIB_NAME)

SRC_DIRS=../../src ../../../libavs3_common ../../../libavs3_debug
SRC=$(foreach TMP_SRC_DIRS, $(SRC_DIRS), $(wildcard $(TMP_SRC_DIRS)/*.c)) 
TARGET_DLL = ../../../bin/$(DLL_NAME)
TARGET_IMPLIB = ../../../bin/$(IMPORT_LIB_NAME)
OBJ:=$(SRC:.c=.o)
