...
SourceSwitch           :=-c 
OutputFile             :=../../../../bin/linux/lib$(ProjectName).dll.a
SharedLibrary          :=../../../../bin/linux/lib$(ProjectName).dll
DefFile                :=lib$(ProjectName).def
...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	$(SharedObjectLinkerName) \
		-Wl,--out-implib=$(OutputFile) \
		-Wl,$(DefFile) \
		-o $(SharedLibrary) \
		@$(ObjectsFileList) $(LibPath) $(Libs) $(LinkOptions)
